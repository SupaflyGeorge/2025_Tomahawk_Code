...
public class SwerveSubsystem extends SubsystemBase {
  ...
  public SwerveSubsystem(File directory) {
    ...
    try {
      swerveDrive = new SwerveParser(directory).createSwerveDrive(Constants.MAX_SPEED,
          new Pose2d(new Translation2d(Meter.of(1.0),
              Meter.of(4.0)),
    ...
    swerveDrive.setModuleEncoderAutoSynchronize(false,
        1.0); // Enable if you want to resynchronize your absolute encoders and motor encoders
  ...
  public SwerveSubsystem(SwerveDriveConfiguration driveCfg, SwerveControllerConfiguration controllerCfg) {
    swerveDrive = new SwerveDrive(driveCfg,
        controllerCfg,
        Constants.MAX_SPEED,
        new Pose2d(new Translation2d(Meter.of(2.0), Meter.of(0.0)),
            Rotation2d.fromDegrees(0.0)));
  }
  ...
  public Command driveToDistanceCommand(double distanceInMeters, double speedInMetersPerSecond) {
    return run(() -> drive(new ChassisSpeeds(speedInMetersPerSecond, 0.0, 0)))
        .until(() -> swerveDrive.getPose().getTranslation().getDistance(new Translation2d(0.0, 0.0)) > distanceInMeters);
  }
  ...
  public Command driveCommand(DoubleSupplier translationX, DoubleSupplier translationY,
    ...
    return run(() -> {
      ...
      swerveDrive.drive(SwerveMath.scaleTranslation(new Translation2d(
          ...
          Math.pow(angularRotationX.getAsDouble(), 3.0) * swerveDrive.getMaximumChassisAngularVelocity(),
          true,
          false);
    });
  }
  ...
  public void addFakeVisionReading() {
    swerveDrive.addVisionMeasurement(new Pose2d(3.0, 3.0, Rotation2d.fromDegrees(65.0)), Timer.getFPGATimestamp());
  }
